...
import com.apex.api.chat.ChatRuntimeHolder
import com.apex.api.chat.ChatRuntimeSlot
...
import com.apex.data.model.SerializableTypography
import com.apex.data.model.toComposeColorScheme
import com.apex.data.model.toComposeTypography
import com.apex.data.model.PromptFunctionType
import com.apex.services.floating.FloatingWindowCallback
...
class FloatingChatService : Service(), FloatingWindowCallback {
    ...
    companion object {
        ...
        const val ACTION_FLOATING_CHAT_SERVICE_STARTED = "com.apex.action.FLOATING_CHAT_SERVICE_STARTED"
        const val ACTION_FLOATING_CHAT_SERVICE_STOPPED = "com.apex.action.FLOATING_CHAT_SERVICE_STOPPED"
        const val ACTION_FLOATING_CHAT_WINDOW_SHOWN = "com.apex.action.FLOATING_CHAT_WINDOW_SHOWN"
        const val ACTION_FLOATING_CHAT_WINDOW_SHOW_FAILED = "com.apex.action.FLOATING_CHAT_WINDOW_SHOW_FAILED"
            ...
            // 设置 EnhancedAIService 就绪回调，以便监听输入处理状?           chatCore.setOnEnhancedAiServiceReady { aiService ->
                ...
                serviceScope.launch {
                    try {
                        ...
                        AppLogger.e(TAG, "监听输入处理状态失败：${e.message})
                    }
                }
            }
            ...
            if (wakeLock == null) {
                ...
                wakeLock =
                        powerManager.newWakeLock(
                                ...
                                "ApexApp:FloatingChatServiceWakeLock"
                        )
