...
import com.apex.core.tools.AutomationExecutionResult
...
import com.apex.agent.core.tools.system.MediaProjectionCaptureManager
...
import com.apex.agent.core.workflow.enhanced.ActionHandler
import com.apex.core.tools.agent.AgentConfig
import com.apex.core.tools.agent.PhoneAgent
import com.apex.core.tools.agent.ShowerController
import com.apex.core.tools.agent.ToolImplementations
...
open class StandardUITools(protected val context: Context) : ToolImplementations {
     ...
     *
     * It captures the current screen to /sdcard/Download/logistra/cleanOnExit for file-based tools.
