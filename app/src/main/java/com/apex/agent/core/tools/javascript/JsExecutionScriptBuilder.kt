...
internal const val TOOLPKG_EXECUTION_ENTRY_FUNCTION = "__ApexExecuteScriptFunction"

private fun buildExecutionPreludeSource(): String {
    return """
        function __ApexGetActiveCallRuntime() {
        ...
        var ApexComposeDslRuntime = globalThis.ApexComposeDslRuntime;
        ...
        (function() {
            ...
            function normalizeComposeResult(value) {
                ...
                if (typeof screenRef === 'function') {
                    ...
                    resolved = text(screenRef.default.__Apex_toolpkg_module_path).trim();
            ...
            root.${TOOLPKG_EXECUTION_ENTRY_FUNCTION} = function(
                ...
                function finalizeCall() {
                    ...
                    if (root.__Apex_call_runtime_ref === callRuntime) {
                        if (
                            ...
                            root.__Apex_call_runtime_ref = previousCallRuntime;
                        } else {
                            try {
                                delete root.__Apex_call_runtime_ref;
                            } catch (_deleteRuntimeError) {
                                root.__Apex_call_runtime_ref = null;
                            }
                        }
                    }
                ...
                function createRuntime() {
                    return {
                        ...
                        getCallerName: function() { return readCallValue('__Apex_package_caller_name', undefined); },
                        getChatId: function() { return readCallValue('__Apex_package_chat_id', undefined); },
                        getCallerCardId: function() { return readCallValue('__Apex_package_caller_card_id', undefined); },
