...
internal fun buildInitRuntimeModules(
    ApexDownloadDir: String,
    ApexCleanOnExitDir: String
    ...
    return listOf(
        ...
        JsBootstrapModule(
            ...
            source = buildRuntimeConstantsScript(
                ApexDownloadDir = ApexDownloadDir,
                ApexCleanOnExitDir = ApexCleanOnExitDir
            )
        ),
        JsBootstrapModule(
...
private fun buildRuntimeExposeScript(): String {
    return """
        function __ApexExpose(name, value) {
        ...
        (function() {
            ...
            windowRef.__ApexGetActiveModuleExports = function() {
                if (
                    ...
                    windowRef.__ApexActiveModule.exports
                ) {
