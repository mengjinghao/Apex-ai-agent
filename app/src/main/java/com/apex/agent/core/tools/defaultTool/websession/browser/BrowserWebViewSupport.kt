...
internal fun StandardBrowserSessionTools.configureWebView(
    ...
    session.webView.apply {
        ...
        addJavascriptInterface(BrowserWebDownloadBridge(this@configureWebView, session), "Apex-AgentWebDownloadBridge")
        addJavascriptInterface(BrowserAsyncBridge(), "Apex-AgentAsyncBridge")
