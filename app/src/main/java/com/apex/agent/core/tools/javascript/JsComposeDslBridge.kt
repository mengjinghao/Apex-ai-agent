...
internal fun buildComposeDslContextBridgeDefinition(): String {
    return """
        var ApexComposeDslRuntime = (function() {
            ...
            function __Apex_define_unit_getter(unitName) {
                try {
            ...
            function __Apex_define_array_unit_getter(unitName) {
                try {
                    if (!unitName || typeof unitName !== 'string') {
                        return;
                    }
            ...
            __Apex_define_unit_getter('px');
            __Apex_define_unit_getter('dp');
            __Apex_define_unit_getter('fraction');
                ...
                var runtime = {
                    ...
                    moduleSpec:
                        options.moduleSpec && typeof options.moduleSpec === 'object'
                            ? options.moduleSpec
                            : {},
                    packageName: String(options.packageName || options.__Apex_ui_package_name || ''),
                    toolPkgId: String(options.toolPkgId || options.__Apex_ui_toolpkg_id || ''),
                    uiModuleId: String(options.uiModuleId || options.__Apex_ui_module_id || ''),
                    callRuntime:
                        options.__Apex_call_runtime && typeof options.__Apex_call_runtime === 'object'
                            ? options.__Apex_call_runtime
                            : null,
                    actionStore: {},
                    actionCounter: 0,
