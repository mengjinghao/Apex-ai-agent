...
internal object UserscriptBootstrapScript {
    const val BRIDGE_NAME = "Apex-AgentUserscriptBridge"

    fun documentStartScript(): String =
        """
        (function() {
            if (window.__apex-agentUserscriptBootstrapInstalled) {
                return;
            }
            window.__apex-agentUserscriptBootstrapInstalled = true;
