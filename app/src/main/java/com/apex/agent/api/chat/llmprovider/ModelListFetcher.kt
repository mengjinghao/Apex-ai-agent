...
import com.apex.data.collects.ApiProviderConfigs
...
object ModelListFetcher {
     ...
     * 从API端点URL派生出模型列表URL
     *
     * @param apiEndpoint 完整的API端点URL (，https://api.openai.com/v1/chat/completions)
     * @param apiProviderType API提供商类    * @return 用于获取模型列表的URL
     */
     ...
     * @param apiProviderType API提供商类    * @return 模型列表结果
     */
