...
import com.apex.agent.ui.screens.chat.TextRecognition
import com.apex.agent.ui.screens.chat.TextRecognizer
...
object OCRUtils {
     ...
     * 从Uri识别文本（同步方法）
     *
     * @param context 上下    * @param uri 图像的Uri
     * @param language 识别语言
     * @param quality 识别质量
     * @return 识别结果
     */
     ...
     * 识别图像中的文本（同时识别拉丁文和中文）
     *
     * @param context 上下    * @param bitmap 图像
     * @param quality 识别质量
     ...
     *
     * @param context 上下    * @param uri 图像Uri
     * @param quality 识别质量
     * @return 识别到的文本，如果失败则返回空字符串
     */
    @WorkerThread
     ...
     * 扫描并提取图像中所有的文本    *
     * @param bitmap 要识别的图像
     * @param languages 要尝试的语言列表，按优先级排    * @param quality 识别质量
     * @return 识别到的所有文本块列表
     */
    @WorkerThread
     ...
     *
     * @param context 上下    * @param bitmap 位图
     * @return 临时文件
     */
    @WorkerThread
