...
const PdfVisionParser = (function () {
    ...
    const EnhancedAIService = Java.type("com.ai.assistance.Apex.api.chat.EnhancedAIService");
    ...
    function createOutputDirectory() {
        const parserRootDir = new File(Apex_CLEAN_ON_EXIT_DIR, "pdf_vision_parser");
