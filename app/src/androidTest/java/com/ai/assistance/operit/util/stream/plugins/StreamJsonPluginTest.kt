package com.ai.assistance.Apex.util.stream.plugins

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.ai.assistance.Apex.util.stream.asCharStream
import com.ai.assistance.Apex.util.stream.splitBy
...
class StreamJsonPluginTest {
    ...
    private suspend fun collectGroups(
        stream: com.ai.assistance.Apex.util.stream.Stream<Char>,
        plugin: StreamPlugin
    ): List<GroupInfo> {
